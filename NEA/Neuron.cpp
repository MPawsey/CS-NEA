...
namespace Machine
{
	...
	{
		auto rand = std::bind(std::normal_distribution{}, EvolutionManager::GetRandomEngine());
	...
	{
		auto pc = std::bind(std::uniform_real_distribution{}, EvolutionManager::GetRandomEngine());
	...
	{
		auto pc = std::bind(std::uniform_real_distribution{}, EvolutionManager::GetRandomEngine());
		auto rand = std::bind(std::normal_distribution{ 0.0, 0.5 }, EvolutionManager::GetRandomEngine());
