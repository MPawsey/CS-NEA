...
namespace Machine
{
	...
	{
		auto rand = std::bind(std::normal_distribution{}, std::default_random_engine{ EvolutionManager::GetSeed() });
	...
	{
		auto pc = std::bind(std::uniform_real_distribution{}, std::default_random_engine{ EvolutionManager::GetSeed() });
	...
	{
		auto pc = std::bind(std::uniform_real_distribution{}, std::default_random_engine{ EvolutionManager::GetSeed });
		auto rand = std::bind(std::normal_distribution{ 0.0, 0.5 }, std::default_random_engine{ EvolutionManager::GetSeed });
