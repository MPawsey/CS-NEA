...
namespace Menu
{
	...
	void SettingsMenu::Init()
	{
		...
		// ROTATION POWER
		m_rotPowLabel = sf::Text{ "Turning power", font };
		...
		// MUTATE SIZE
		m_mutSizeLabel = sf::Text{ "Mutation size", font };
		m_mutSizeLabel.setPosition(xPos1, yPos);
		m_mutSizeMinusBtn = UI::Button{ "-", m_settingsView };
